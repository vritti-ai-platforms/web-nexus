...
export const ALL_REMOTES: RemoteConfig[] = [
  {
    name: 'VrittiAuth',
    entry: import.meta.env.VITE_VRITTI_AUTH_URL || 'https://localhost:3001/mf-manifest.json',
    exposedModule: 'routes',
    baseUrl: import.meta.env.VITE_VRITTI_AUTH_BASE_URL || 'https://localhost:3001',
  },
